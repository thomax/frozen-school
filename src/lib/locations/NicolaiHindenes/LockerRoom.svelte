<script>
  ...
  function finishSorting() {
    if (
      redSockInCorrectZone &&
      blueSockInCorrectZone &&
      greenSockInCorrectZone &&
  ...
  function onDragMoveRed(x, y, dx, dy) {
    DraggableRedSockX = x
    DraggableRedSockY = y
  }
  function onDragMoveBlue(x, y, dx, dy) {
    DraggableBlueSockX = x
    DraggableBlueSockY = y
  }
  function onDragMoveGreen(x, y, dx, dy) {
    DraggableGreenSockX = x
    DraggableGreenSockY = y
  }
  function onDragMoveYellow(x, y, dx, dy) {
    DraggableYellowSockX = x
  ...
  {#if showSorting}
    ...
    height:{DraggableRedSockHeight}px;"
        use:asDroppable={{
          ...
          Operations: 'copy',
          DataToOffer: {'image/gif': 'Red Sock'},
          onDropped
        }}
      >
    ...
    height:{DraggableBlueSockHeight}px;"
        use:asDroppable={{
          ...
          Operations: 'copy',
          DataToOffer: {'image/gif': 'Blue Sock'},
          onDropped
        }}
      >
    ...
    height:{DraggableGreenSockHeight}px;"
        use:asDroppable={{
          ...
          Operations: 'copy',
          DataToOffer: {'image/gif': 'Green Sock'},
          onDropped
        }}
      >
    ...
    height:{DraggableYellowSockHeight}px;"
        use:asDroppable={{
          ...
          Operations: 'copy',
          DataToOffer: {'image/gif': 'Yellow Sock'},
          onDropped
        }}
      >
